...
import com.fei.wxserver.domain.AccessToken;
import com.fei.wxserver.domain.AccessTokenInfo;
...
public class GetToken implements ApplicationRunner {
    ...
    public void getToken() {
        ...
        new Thread(() -> AccessTokenInfo.accessToken = getAccessToken(wxProperties.getAppId(), wxProperties.getAppSecret()));
    }
